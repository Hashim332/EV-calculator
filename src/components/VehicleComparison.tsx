...
const VehicleComparison: React.FC<VehicleComparisonProps> = ({ vehicle1, vehicle2 }) => {
  const formatValue = (value: any, isCurrency: boolean = false, isPercentage: boolean = false): string => {
  ...
  const getVehicleValue = (vehicle: Vehicle | null, attribute: keyof Vehicle): string => {
