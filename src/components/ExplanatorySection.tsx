...
export function WhatDoesThisToolDoSection() {
  return (
    <section className="w-full max-w-3xl mx-auto mb-6 md:mb-8 bg-violet-100 border border-violet-200 rounded-xl p-4 sm:p-6 md:p-8 text-center relative overflow-hidden">
      <div className="relative z-10">
        ...
        <p className="text-gray-700 mb-4 text-sm">
          This tool helps you compare the true cost of different vehicle
          ownership models. <span className="font-medium">Mix and match</span>{" "}
          between buying or leasing{" "}
          <span className="font-medium">electric vehicles (EVs)</span> and{" "}
          <span className="font-medium">petrol/diesel (ICE) cars</span>. Compare
          leasing to leasing, buying to buying, or any combination that fits
          your needs. It takes into account lease payments, purchase prices,
          running costs, depreciation, and resale values to show which option is
          more economically viable for you.
        </p>
      </div>
    </section>
  );
      ...
      <div className="relative z-10">
        ...
        <ol className="flex flex-col md:flex-row items-center md:items-start justify-center gap-4 md:gap-8 mb-2">
          ...
          <li className="flex flex-col items-center w-full sm:w-64 md:w-48 self-auto">
            ...
            <span className="text-gray-700 text-center text-sm">
              Select specific vehicles to compare. For fair comparisons, pick
              cars that are similar in size, price range, or segment.
            </span>
          </li>
          <li className="flex flex-col items-center w-full sm:w-64 md:w-48 self-auto">
            <div className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-violet-500 text-white font-bold text-base mb-2 shadow-md">
          ...
          <li className="flex flex-col items-center w-full sm:w-64 md:w-48 self-auto">
            ...
            <span className="text-gray-700 text-center text-sm">
              Make an informed decision based on which ownership model and
              vehicle best fits your budget and lifestyle.
            </span>
          </li>
        </ol>
      </div>
...
export function ExplanatoryAccordion() {
  return (
    <div className="w-full my-6">
      <Accordion
        type="single"
        collapsible
        defaultValue="what-does-this-tool-do"
      >
            ...
            <section className="w-full max-w-3xl mx-auto mb-6 md:mb-8 bg-violet-100 border border-violet-200 rounded-xl p-4 sm:p-6 md:p-8 text-center relative overflow-hidden">
              <div className="relative z-10 text-gray-700 text-sm">
                ...
                <ul className="text-left space-y-2 max-w-md mx-auto">
                  <li>
                    <strong>EV Lease vs ICE Purchase:</strong> Compare leasing
                    an electric car to buying a petrol/diesel car
                  </li>
                  <li>
            ...
            <section className="w-full max-w-3xl mx-auto mb-6 md:mb-8 bg-violet-100 border border-violet-200 rounded-xl p-4 sm:p-6 md:p-8 text-center relative overflow-hidden">
              <div className="relative z-10 text-gray-700 text-sm">
                <p className="mb-2">
                  ...
                  speed, and features every few years. Leasing lets you access
                  the latest technology without worrying about long-term
                  depreciation or battery degradation. However, if you drive
                  high mileage or prefer ownership, buying might make more sense
                  - that's why this tool helps you compare all options fairly.
                </p>
              </div>
            </section>
          </AccordionContent>
